...
import { clearCart, getCartAPI, mergeCartAPI } from '@/store/slices/cartSlice';
...
function Login() {
    ...
    return (
        // [MODIFIED] Background: Dark Slate with Ambient Glow
        <div className="flex items-center justify-center min-h-screen bg-[#020617] relative overflow-hidden">
            ...
            >
                {/* [MODIFIED] Card: Glassmorphism Dark */}
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                            ...
                            <Controller
                                ...
                                render={({ field }) => (
                                    <motion.input
                                        ...
                                        // [MODIFIED] Input Styles: Dark & Borderless look
                    ...
                    <motion.div variants={itemVariants} className="pt-4">
                        <motion.button
                            ...
                            // [MODIFIED] Button: Gradient Indigo/Purple
