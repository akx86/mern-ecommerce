...
import { Save, Upload, Image as ImageIcon, ChevronLeft, LayoutGrid, DollarSign, Package, FileText, Loader2, AlertTriangle } from 'lucide-react';
    ...
    if (isError) {
        return (
            <div className="min-h-[60vh] flex flex-col items-center justify-center text-red-400 gap-4">
                ...
                <p className="text-xl font-medium">Error loading product details.</p>
                <Link to="/admin/products" className="text-cyan-500 hover:text-cyan-400 text-sm hover:underline">
                    Return to Products
                </Link>
            </div>
        );
