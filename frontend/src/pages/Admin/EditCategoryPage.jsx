...
import { Save, Upload, Image as ImageIcon, ChevronLeft, FileText, Loader2, AlertTriangle } from 'lucide-react';
...
const EditCategoryPage = () => {
    ...
    const { mutate, isPending: isSaving } = useMutation({
        mutationFn: (dataToSend) => updateCategory(id, dataToSend),
        onSuccess: () => {
    ...
    if (isError) {
        return (
            <div className="min-h-[60vh] flex flex-col items-center justify-center text-red-400 gap-4">
                ...
                <p className="text-xl font-medium">Error loading category details.</p>
                <Link to="/admin/categories" className="text-cyan-500 hover:text-cyan-400 text-sm hover:underline">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-zinc-400 text-sm">Update category details and cover image</p>
                    </div>
                </div>
                    ...
                    <div className="bg-slate-900/30 backdrop-blur-xl border border-white/10 rounded-2xl p-8 space-y-6">
                        ...
                        <div className="p-4 rounded-xl bg-cyan-500/5 border border-cyan-500/10 flex gap-3 items-start">
                             ...
                             <div className="space-y-1">
                                <p className="text-sm font-medium text-cyan-200">Helpful Tips</p>
                                <p className="text-xs text-cyan-200/60 leading-relaxed">
                                    Choose a short and descriptive name for your category. The cover image will be used in the shop grid view.
                                </p>
                             </div>
                        </div>
