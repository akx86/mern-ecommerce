...
import { Save, X, Upload, Image as ImageIcon, ChevronLeft, LayoutGrid, DollarSign, Package, FileText } from 'lucide-react';
...
const EditProductPage = () => {
    ...
    const handleSubmit = () => {
        ...
        mutate({ id: productId, productData: dataToSend });
    };
    ...
    if (isError) { return <div className="text-red-500">Error loading product</div> }
    ...
    return (
        <div className="max-w-5xl mx-auto space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500 pb-10">
            ...
            {/* 🔥 التعديل: flex-col للموبايل عشان يرص العناصر فوق بعض */}
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-zinc-400 text-sm">Update product details and media</p>
                    </div>
                </div>

                {/* Actions - Responsive Update */}
                {/* 🔥 التعديل: الزراير تاخد العرض كامل في الموبايل */}
            ...
            {/* 2. Main Content Grid */}
            {/* 🔥 التعديل: Grid system already handles responsiveness well (stacking on mobile) */}
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-1 space-y-6">
                    <div className="bg-slate-900/30 backdrop-blur-xl border border-white/10 rounded-2xl p-6">
                        ...
                        {/* Image Preview Area */}
                        <div className="relative group w-full aspect-square bg-black/40 border-2 border-dashed border-white/10 rounded-xl overflow-hidden flex flex-col items-center justify-center transition-colors hover:border-cyan-500/50">
                            {imagePreview ? (
                                <img
                                    src={imagePreview}
                                    alt="Preview"
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                ...
                                <select
                                    ...
                                    onChange={handleChange}
                                    className="w-full bg-black/20 border border-white/10 rounded-xl pl-10 pr-4 py-3 text-zinc-300 focus:outline-none focus:border-cyan-500/50 focus:ring-1 focus:ring-cyan-500/20 transition-all appearance-none">
