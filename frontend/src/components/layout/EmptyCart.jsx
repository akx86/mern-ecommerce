...
function EmptyCart() {
  return (
    // [FIX 1] min-h-screen: عشان ياخد طول الشاشة كلها
    // [FIX 2] pt-32: عشان ينزل تحت الناف بار وميلزقش فيه
    <div className="min-h-screen flex flex-col items-center justify-center text-center px-4 bg-[#020617] pt-32 pb-12 relative overflow-hidden">
