...
const ProductCard = (props) => {
  ...
  return (
    <motion.div 
      ...
      whileHover="hover"
      // [تعديل النسبة] هنا خليتها 4/5 عشان الكارد ميبقاش طويل بزيادة ويكون متناسق
        ...
        <div className="absolute bottom-0 left-0 right-0 p-4 z-20">
            ...
            >
                <button
                 onClick={onAdd}
                 disabled={stock <= 0}
                 // [تعديل] رجعت كلمة Out of Stock زي ما كانت
...
// [تعديل] رجعت السكيلتون كامل زي ما كان عندك
